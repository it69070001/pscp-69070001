...
```text
โจทย์ให้รับ input 2 ค่าเป็นเเม่สีทั้ง 3 สีซ้ำกันได้ ทีละบรรทัด เเละให้  output เป็นสี 2 สีที่รับมาผสมกัน ถ้า input ไม่ใช่เเม่สีให้ output เป็น error 
...
```text
Step 1: ตรวจสอบว่า  input เป็นเเม่สีมั้ย ถ้าไม่จิงก็ error
Step 2: ตรวจสอบว่า  input ทั้งสอง เป็นสีเดียวกันมั้ย ถ้าจิงก็ให้ output เป็นสีนั้น
Step 3: ตรวจสอบว่า input ทั้งสอง ถ้าเข้าเงื่อนไข เเสดงว่าผสมได้สีอะไร
```
...
```text
มีการเปลี่ยนเเปลงเล็กน้อย เพราะ input ทั้งสองค่า เขียนสลับกันได้ เช่น YellowBlue , BlueYellow
```
...
```text
สีที่เดียวกัน ผสมกัน ควรได้สีเดิม
```
...
```text
หากไม่ใช่เเม่สี ควรขึ้นว่า "Error"
```
...
```text
ผสมเเม่สี ควรออกมา ตามเงื่อนไข
```
