...
```text
โจทย์ให้สะสมคะเเนนตั้งเเต่ 0 โดยมี 2 การกระทำคือ +10 เเละ -5 เเละจะทำจำนวน N ครั้ง

Input:
จำนวนการกระทำ N ครั้ง
เเละการกระทำตั้งเเต่ 1 - N บรรทัด

Output:
เป็นคะเเนนสะสมทั้งหมด เป็นจำนวนเต็ม

Constraints:
input จํานวนเต็ม N (1 ≤ N ≤ 1,000)
```
...
```text
Step 1: รับค่าจำนวน N
Step 2: loop รับค่า + - จำนวน N ครั้ง
Step 3: หากว่า เป็น + ให้ +10 point 
Step 4: เเสดงคะเเนนสะสม
```
...
```text
เหมือนเดิม ใช้ loop เช็ค เงื่อนไข ว่าเป็น + หรือ - 
```
