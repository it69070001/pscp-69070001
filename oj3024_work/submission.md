...
```text
โจทย์ให้เเจ้งว่ามีโอกาศเกิดความรู้สึก Surprising หรือไม่โดยให้มาเเค่คะเเนนโหวตสูงสุดกับคะเเนนโหวตรวม

input: 
ให้รับค่าคะเเนนรวมเเละคะเเนนสูงสุดทีละบรรทัดเป็นจำนวนเต็ม

output:
ผลโหวตนั้นมีโอกาศเกิด Surprising หรือไม่

constraints:
หากว่า คะเเนนสูงสุดกับต่ำสุดห่างกันเกิน 2 คะเเนน จะทำให้เิกิด Surprising
```
...
```text
Step 1: อ่านจำนวนเต็มทั้งสอง
Step 2: เอาคะเเนนสูงสุดไป *3 - คะเเนนรวม
Step 3:ตรวจสอบว่าผลลัพท์ > 4 หรื่อไม่ ถ้าใช่ เเสดงว่า Surprising
```
...
```text
การใช้ค่าสูงสุดไป *2 เเล้วนำไปลบกับ คะเเนนรวม จะได้คะเเนนต่ำสุด หลังจากนั้นนำไป - ลบกับ ค่าสูงสุด หากมากว่า 2 ให้เเสดงว่า  Surprising 
```
...
```text
กรณีที่ คะเเนนสูงสุดมากว่าคะเเนนรวมเกินครึ่ง 
```
...
```text
กรณี คะเเนนสูงสุดน้อยกว่าครึ่งคะเเนนรวม
```
...
```text
กรณีที่คะแนนสูงสุด และคะแนนต่ำสุดห่างกันไม่เกินสองคะแนน 
```
...
```text
วิธีคิดเลขก่อนหน้ามันผิด เขาช่วยปรับให้ตรงกับที่โจทย์ต้องการ
```

คุณยังทำอะไรด้วยตนเอง

```text
ยังเขียนโค้ดเเละคิดเป็นหลักการเป็นส่วนใหญ่
```
