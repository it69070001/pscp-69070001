...
```text
ใส่กรอบโดยใช้ * กับ input 

Input:
รับ input 5 บรรทัด ทีละ 1 บรรทัด

Output:
เเสดง * รอบกลุ่มคำ โดยเว้น space ซ้ายขวา 1 ช่อง

Constraints:
กรอบจะต้องมีความยาวตามข้อความที่ยาวที่สุด
```
...
Step 3: วางกรอบด้านบนเเละด้านล่าง
Step 4: วางเงื่อนไขของกรอบซ้ายขวา
...
```text
เหมือนเดิมเพราะ สั้น เข้าใจง่าย
```
...
```text
มีช่องระหว่างข้อความ เเละบรรทัดว่าง
```
