...
```text
โจทย์ให้หาททางไปที่ห้องที่ 1 ที่พังกำเเพงในปราสาท น้อยที่สุด

Input:
รับจำนวนห้องที่อยู่ปัจจุบัน เป็นจำนวนเต็ม

Output:
จำนวนการพังกำเเพงที่น้อยที่สุดที่จะไปถึงห้องที่ 1

Constraints:
ห้องเลขคู่เลขคู่เเต่ละชั้นมีด้านที่ทำให้พังได้น้อยกว่าปกติ
```
...
```text
Step 1: รับค่าจำนวนเต็ม  a
Step 2: loop (i+1)**2 
Step 3: ตรวจสอบว่า a <= i
Step 4: หาเเถวห้องที่มีห้อง a ว่าเป็นเลขคู่หรือคี่
Step 5: หาว่า a ว่าเป็นเลขคู่หรือคี่
Step 6: หาระยะ a ถึง ห้อง 1
Step 7: เเสดงจำนวนการพังกำเเพงที่น้อยที่สุดที่จะไปถึงห้องที่ 1
...
```text
เหมือนเดิม ใช้ loop หาที่อยู่ของห้องหลังจากนั้นก็ใช้คณิต คำนวนจำนวนการพังกำเเพงที่น้อยที่สุดที่จะไปถึงห้องที่ 1
```
