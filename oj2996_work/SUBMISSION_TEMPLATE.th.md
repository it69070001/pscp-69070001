...
```text
โจทย์บอกว่าให้รับ input 5 ตัวอักษรไม่สนขนาด เเละให้สลับให้ output เรียงข้อความจากหลังไปหน้าเเละเป็นตัวอักษรพิมเล็กทั้งหมด
```
...
```text
Step 1:ประกาศตัวเเปร x ให้รับค่า input เป็นตัวอักษร
Step 2:ใช้ if else ให้รับ input เเค่ 5 ตัว
Step 3:print ค่าในตัวเเปรให้ออกมาในตัวพิมเล็กทั้งหมด โดยใช้ .lowwer()
Step 4:ใช้ [] เพื่อให้ให้ตำเเหน่งพิมกลับหลัง
```
...
```text
เหมือนกัน เพราะโครงสร้างง่าย ตรงตัว
```
...
```text
นึกหาวิธี เรียงตัวอักษรกลับด้าน
```

คุณยังทำอะไรด้วยตนเอง

```text
นอกเหนือจากนั้น ทำเอง
```
