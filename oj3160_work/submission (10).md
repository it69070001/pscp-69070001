...
```text
โจทย์ให้หาจำนวนเฉพาะที่อยู่ในช่วงที่กำหนด

Input:
ให้รับจำนวนเต็ม สองจำนวนในบรรทัดเดียว
 1.เลขเเรกของช่วง 2.เลขท้ายของช่วง

Output:
เเสดงตัวเลขที่เป็นจำนวนเฉพาะว่าคือจำนวนอะไรบ้างเเละมีกี่จำนวน

Constraints:
จำนวนเฉพาะไม่มีติดลบ ทำให้ input >= 1
```
...
```text
Step 1: อ่านจำนวนเต็ม a เเละ b
Step 2: loop โดยเริ่มจาก a ถึง b
Step 3: เช็ค ว่าเป็นจำนวนเฉพาะหรือไม่ เเละเก็บใว้ใน array
Step 4: เเสดงตัวเลขที่เป็นจำนวนเฉพาะว่าคือจำนวนอะไรบ้างเเละมีกี่จำนวน
```
...
```text
เหมือนเดิมใช้ loop เช็คเก็บข้อมูลใน array
```
...
```text
กรณี ที่เลขเริ่มต้นเเละเลขสุดท้ายเท่ากัน
```
