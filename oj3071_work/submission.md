...
```text
โจทย์ให้เเสดงตัวเลขที่อยู่ในช่วง a-b ที่หาร d เเล้วเหลือเศษ r

input:
 รับค่า a,b,d,rทีละบรรทัด

output :
เเสดงออกมาเป็นตัวเลขจำนวนเต็มที่อยู่ในช่วง a-b ที่หาร d เเล้วเหลือเศษ r 

constraints:
ให้ output ต้องอยู่ในช่วง a-b 
```
...
```text
Step 1:รับค่าตัวเลขทั้งหมด
Step 1: ใช้ if หาช่วงของตัวเลข
Step 1:loop เก็บตัวเลขที่ตรงเงื่อนไข
Step 1:หยุดเมื่อ ตัวเลขไม่อยู่ในช่วง เเละเเสดงคำตอบ
```
...
```text
เหมือนเดิม ใช้ loop เก็บตัวเลขที่ตรงเงื่อนไข เเล้วเเสดงจำนวนที่ตรงเงื่อนไข
```
