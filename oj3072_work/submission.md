...
```text
โจทย์ให้นับสระ a,e,i,o,u ที่รับค่ามา เเละเเสดงว่า มีกี่ตัว

input:
 รับคำมา จำนวนตั้งเเต่ 1 - 1000

output :
เเสดงว่ามีสระตัวไหน กี่ตัวบ้าง

constraints:
หากไม่มีสระตัวนั้นเลย ก็ไม่ต้องเเสดง เเละ ตัวเล็กตัวใหญ่ก็มีค่าเหมือนกัน
```
...
```text
Step 1: อ่านตัวอักษรเเละหาความยาวคำโดยใช้ len
Step 2: loop หาว่า ตั้งเเต่ คำเเรกถึงคำสุดท้าย มีสระอยู่หรือไม่ ถ้าใช่เก็บใว้ในตัวเเปร
Step 3: เเสดงสระที่อยู่ในคำออกมา
```
...
```text
เหมือนเดิม ใช้ loop หาที่ละตำเเหน่งของคำว่าใช่ สระหรือไม่ เเละเก็บใว้ในตัวเเปร
```
