...
```text
โจทย์ให้รับค่าอาหาร จำนวนเต็ม เเละให้ output เป็นค่าอาหารที่คิดค่าบริการ 10% ขั้นต่ำ 50 มากสุดที่ 1000 เเละคิด vat อีก 7% 
...
```text
Step 1: ตรวจสอบ10% ของราคาอาหาร < 50 ถ้าจิงให้ ค่าบริการ = 50
Step 2: ตรวจสอบ10% ของราคาอาหาร  > 50 เเต่น้อยกว่า 1000 ถ้าจิงให้ ค่าบริการ = 10%ของราคา
Step 3: ตรวจสอบ10% ของราคาอาหาร > 1000 ถ้าจิงให้ ค่าบริการ = 1000
Step 4: นำไปหารกับ Vat 7% เเสดงคำตอบ
```
...
```text
เหมือนเดิม เพราะ เป็นไปตามเงื่อนไข โจทย์
```
...
```text
เก็บค่าบริการขั้นต่ำของค่าบริการ ควรเป็น 50 บาท
```
...
```text
เงื่อนไขค่าบริการตามปกติ ที่อยู่ระหว่าง 50 - 1000
```
