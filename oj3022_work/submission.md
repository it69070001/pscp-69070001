...
```text
input:
 จำนวนจริงเป็นค่าองศา 
เเละรับ หน่วยองศาเเรก เเละหน่วยที่ต้องการเเปลง

output :
ค่าของหน่วยที่เเปลงจากหน่วยเเรกไปเป็นหน่วยที่สอง

constraints:
จะต้องสามารถ เเปลง สลับกันกันได้ เเละการเเปลงเป็นหน่วยเดิมต้องได้หน่วยเดิม
```
...
```text
Step 1: สร้างฟังชั่น ของการเเปลงหน่วย ของทุกอุณหภูมิ
Step 2: ตรวจสอบว่าค่าที่รับมาเป็นหน่วยใด เเล้วเปลี่ยนเป็นองศา C
Step 3: ตรวจสอบว่า input ให้เเปลงเป็นหน่วยใด
Step 4: เเสดงออกมาเป็นหน่วยที่ต้องการ
```
...
```text
เหมือนเดิม เพราะ ใช้ฟังชั่น ลดการทำซ้ำได้มาก
```
