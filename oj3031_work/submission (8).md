...
```text
โจทย์ให้หาว่าหมึกที่ไหลเพิ่มขึ้นวินาทีละ  S ต่อตารางหน่วย จะไปโดนบ้านของคน ที่ x,y ใน กี่วินาที
Input:
บรรทัดเเรกให้รับว่าหมึกที่ไหลเพิ่มขึ้นวินาทีละ  S ต่อตารางหน่วย เเละจำนวนบ้านที่ N ร้องเรียน
บรรทัดที่ 2 - N ตำเเหน่ง x,y ของเเต่ละบ้าน

Output:
จำนวนวินาทีที่หมึกจะไปถึง x,y ของบ้านที่ 1 - N

Constraints:
หากวินาทีเป็นเศษให้ปัดเศษให้เป็นจำนวนเต็ม
```
...
```text
Step 1: รับค่า S เเละ คำร้องเรียนมา N หน่วย
Step 2: loop รับ x,y จำวนวน N ครั้ง
Step 3: นำ S มาหาขนาดหมึกที่เพิ่มขึ้นเรื่อยๆ
Step 4: loop check ขนาดหมึกว่าจะไปถึงบ้านที่วินาทีเท่าไร
Step5: เเสดงวินาที เป็นจำนวนเต็ม
```
...
Step 1: รับค่า S เเละ คำร้องเรียนมา N หน่วย
Step 2: loop รับ x,y จำวนวน N ครั้ง
Step 3: นำ x,y ไปหา ขนาดหมึก 
Step 4:นำขนาดไปหารกับ S เพื่อหาวินาทีที่ หมึกจะมาจะถึงบ้าน
Step5: เเสดงวินาที เป็นจำนวนเต็ม
```
...
```text
กรณีที่บ้านอยู่ที่ จุดตกของหมึก
```
...
```text
เปลี่ยนวิธีคิดหาคำตอบให้ง่ายขึ้น
```
